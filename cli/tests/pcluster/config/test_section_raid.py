...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("raid_type", "0", 0, None),
        ("raid_type", "1", 1, None),
        ("num_of_raid_volumes", None, None, None),
        ("num_of_raid_volumes", "", None, None),
        ...
        ("num_of_raid_volumes", "1", 1, None),
        ("volume_type", None, "gp2", None),
        ("volume_type", "", "gp2", None),
