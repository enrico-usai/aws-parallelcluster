...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("base_os", "ubuntu1404", "ubuntu1404", None),
        ...
        ("spot_price", None, 0, None),
        ("spot_price", "", 0, None),
        ("spot_price", "NONE", None, "must be an Integer"),
        ("spot_price", "wrong_value", None, "must be an Integer"),
        ("spot_price", "1", 1, None),
        ("spot_price", "20", 20, None),
