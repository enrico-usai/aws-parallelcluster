...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("ssh_from", "1.1.1.1/2", None, "Allowed values are"),
        ("ssh_from", "1.1.1.1/15", None, "Allowed values are"),
        ...
        ("compute_subnet_cidr", "1.1.1.1/2", None, "Allowed values are"),
        ("compute_subnet_cidr", "1.1.1.1/15", None, "Allowed values are"),
        ...
        ("vpc_security_group_id", "", None, None),
